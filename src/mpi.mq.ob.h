...
namespace chifit {
  ...
  GiNaC::ex get_M_pm_sq_ob_Xpression(ParameterMap &pm,bool withFS=true);
  GiNaC::ex get_M_0_sq_ob_Xpression(ParameterMap &pm,bool withFS=true);
  GiNaC::ex get_f_pm_ob_Xpression(ParameterMap &pm,bool withFS=true);
